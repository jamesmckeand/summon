              ...
              {artists.map((artist, i) => {
                ...
                return (
                  <Link key={artist.id} href={`/artist/${artist.id}`}>
                    <div className="glass rounded-xl p-4 flex items-center gap-4 hover:border-primary/20 transition-all group">
                      <span className="text-muted-foreground text-sm font-mono w-6 text-center shrink-0">{i + 1}</span>
